describe('Verify that User is able to successfully navigate to the Homepage', () => {
  it('Opens Booking.com homepage', () => {
    ...
    // (Optional) You can also verify that the logo or search bar is visible
